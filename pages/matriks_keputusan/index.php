...
<div class="col-lg-12 grid-margin stretch-card">
    <div class="card">
        <div class="card-body">
            ...
            <a href="add.php" class="btn btn-primary" style="margin-bottom: 20px;">Tambah Data</a>
            ...
            // Jika tahun sudah dipilih, tampilkan form pencarian
            if ($tahun_filter) {
            ?>
                ...
                <tbody>
                    ...
                    ?>
                            <tr class="text-center">
                                ...
                                ?>
                                <td>
                                    <a href="edit.php?alternatif=<?= $alternatif ?>&tahun=<?= $tahun_filter ?>" class="btn btn-warning btn-sm">Edit</a>
                                    <a onclick="return confirm('Yakin ingin menghapus data ini?')" href="delete.php?alternatif=<?= $alternatif ?>&tahun=<?= $tahun_filter ?>" class="btn btn-danger btn-sm">Delete</a>
                                </td>
                            </tr>
                    <?php
                        }
